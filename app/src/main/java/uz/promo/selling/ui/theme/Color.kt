...
// Premium (gold) accent — single source of truth for premium surfaces/badges.
internal val PremiumGold = Color(0xFFCBA135)
internal val PremiumGoldDark = Color(0xFFB8860B)
internal val PremiumGoldLight = Color(0xFFEDCF7A)
