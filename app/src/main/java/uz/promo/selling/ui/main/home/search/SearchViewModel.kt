...
import uz.promo.selling.data.local.SearchHistoryEntity
import uz.promo.selling.data.remote.models.searchSuggestion.CategorySuggestion
import uz.promo.selling.domain.state.Resource
import uz.promo.selling.domain.useCase.SearchSuggestionsUseCase
